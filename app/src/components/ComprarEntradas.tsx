...
export function ComprarEntradas({ eventoId, autoridadEvento, onCompraRealizada }: { eventoId: string; autoridadEvento: PublicKey; onCompraRealizada?: () => void | Promise<void> }) {
